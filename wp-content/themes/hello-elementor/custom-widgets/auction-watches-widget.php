...
class Auction_Watches_Widget extends Widget_Base {
	...
	protected function render() {
        ...
        $q_auction_name = encodeURIComponent($_GET['auctionName']);
        $q_auction_type = $_GET['auctionType'];
        $q_auction_title = encodeURIComponent($_GET['auctionTitle']);
        ...
        $auctionTitleQueryParam = $q_auction_title == '' ? '' : "&auction_title__in=$q_auction_title";
        ...
        foreach ($q_auction_status as $status) {
            $auctionStatusQueryParam = "$auctionStatusQueryParam&status__in=$status";
        }
        ...
        $url = "http://128.199.148.89:8000/api/v1/auction/watches?$auctionNameParam$auctionTypeQueryParam$auctionTitleQueryParam$auctionMinEstPriceQueryParam$auctionMaxEstPriceQueryParam$auctionMinBidQueryParam$auctionMaxBidQueryParam$auctionStatusQueryParam";
        echo $url;
        ...
        renderAuctionWatchesResultsWithFilter($body->auctionWatches);
	}
